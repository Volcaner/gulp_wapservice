var publicState={
	...
	orderState:"0",//页面状态(所有订单0,未付款1,未发货2,已发货3,仅退款中4,退货中5,换货中6,交易成功9,交易关闭10)
	traId:'',
	tradeFlag:'',
